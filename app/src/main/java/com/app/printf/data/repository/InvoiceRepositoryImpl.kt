...
class InvoiceRepositoryImpl(
    ...
    override suspend fun getNextInvoiceNumber(dateMillis: Long, lastUsedNumber: String?): String {
        val existing = invoiceDao.getAllInvoiceNumbers()
        val fromDatabase = InvoiceNumberUtils.suggestNext(existing, dateMillis)
        return if (lastUsedNumber.isNullOrBlank()) {
            fromDatabase
        } else {
            InvoiceNumberUtils.suggestNextAfter(
